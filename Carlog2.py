...
#Automactically updates values in widget
total_money_spent_var = tk.StringVar()
total_money_spent_label = tk.Label(carlog_page, textvariable=total_money_spent_var, font=("Lato", 12))
total_money_spent_label.place(relx=0.05, rely=0.85, anchor="nw")

avg_monthly_spending_var = tk.StringVar()
avg_monthly_spending_label = tk.Label(carlog_page, textvariable=avg_monthly_spending_var, font=("Lato", 12))
avg_monthly_spending_label.place(relx=0.05, rely=0.9, anchor="nw")
