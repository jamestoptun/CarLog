...
def main():
    ...
    username_entry = tk.Entry(frame_signup, width=40)
    ...
    password_entry = tk.Entry(frame_signup, width=40, show="*")
    ...
    confirm_password_entry = tk.Entry(frame_signup, width=40, show="*")
    ...
    email_entry = tk.Entry(frame_signup, width=40)
    ...
    entry_login_username = tk.Entry(frame_login, width=40)
    ...
    entry_login_password = tk.Entry(frame_login, width=40, show="*")
